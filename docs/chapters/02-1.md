...
It’s more intuitive to think of it in terms of perturbation. Perturbing $s$ by $\mathrm{d}s$ will perturb $z$ by: $$\mathrm{d}z = \mathrm{d}s \cdot h'(s)$$Thus this will perturb C by: 
$$
