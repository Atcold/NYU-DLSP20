...
* নিচের **চিত্র ১(ক)** লক্ষ্য কর| এই গ্রাফের বিন্দুগুলো একটি স্পাইরাল এর শাখায় অবস্থান করছে, এবং এগুলো $\R^2$ এর| প্রতিটি রং ই একেকটি শ্রেণী (ক্লাস) বুঝাচ্ছে| একক (ইউনিক) শ্রেণীর সংখ্যা এখানে $K = 3$| গাণিতিকভাবে সমীকরণ **সমীকরণ ১(ক)** তে এটি তুলে ধরা হয়েছে|
