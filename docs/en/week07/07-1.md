...
[comment]: # (lang-ref: ch.07-1)
[comment]: # (Time: 0:0:1 - 0:26:00)
[comment]: # (Author: Karanbir Chahal)
...
[comment]: # (lang-ref: ch.07-1)
[comment]: # (Time: 0:25:26 - 0:43:41)
[comment]: # (Author: Meiyi He)
...
[comment]: # (lang-ref: ch.07-1)
[comment]: # (Time: 0:42:00 - 0:51:00)
[comment]: # (Author: Alexander Gao)
...
Under the definition of $F_\beta(x, y)$ above, $P(y|x)$ is just an application of the Gibbs-Boltzman formula.  And $z$ has been marginalized implicitly inside of this.  Physicists call this "Free Energy" by the way, which is why we call it $F$.   So $e$ is the energy, and $F$ is free energy.
