...
The reason why ClusterFit works is that in the clustering step only the essential information is captured, and artifacts are thrown away making the second network learn something slightly more generic.
