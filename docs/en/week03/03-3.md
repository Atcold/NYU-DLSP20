...
|<img src="({% link /images/week03/03-3/Figure 2(a) Before Applying Sparsity.png %}" width="300"/> | <img src="({% link /images/week03/03-3/Figure 2(b) After Applying Sparsity.png %}" width="300"/>|
...
|<img src="({% link /images/week03/03-3/Figure 3(a) Before Applying Parameter Sharing.png %}" width="300"/> | <img src="({% link /images/week03/03-3/Figure 3(b) After Applying Parameter Sharing.png %}" width="300"/>|
