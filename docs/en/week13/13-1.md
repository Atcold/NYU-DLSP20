...
$\langle\Bigg[w_{j_3}^\ell\Bigg], \Bigg[h_{ij_3}^\ell \Bigg]\rangle$  and $\langle\Bigg[w_{j_3}^\ell\Bigg], \Bigg[h_{i'j_3}^\ell \Bigg]\rangle$ 
...
<b>Fig. 15</b>: Different Neighborhood sizes
</center>
...
<b>Fig. 16</b>: Grid/Euclidean Domain
</center>
