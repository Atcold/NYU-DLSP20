...
```
## Q&A 
### 1. How does GAN train? Do both genrator and disciminator train at the same time?
 Answer: A typical GAN alternates between training the discriminator and training the generator. There is some [research ](https://arxiv.org/abs/1706.04156) on training the generator and discriminator simultaneously.
