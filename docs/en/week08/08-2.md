...
<center>
<img src="https://i.imgur.com/pMxDX4q.png" height="50%" width="50%"/><br>
...
<center>
<img src="https://i.imgur.com/exta8bF.png" width="90%"/><br>
<b>Fig. 2</b>: FISTA computation graph
</center>

FISTA (fast ISTA) is an algorithm that optimizes the sparse coding energy function $E(y,z)$ with respect to $z$ by alternately optimizing the two terms $||y - Wz||^2$ and $\lambda ||z||_{L^1}$. We initialize $Z(0)$ and iteratively update $Z$ according to the following rule:

$$z(t + 1) = \text{Shrinkage}_\frac{\lambda}{L}(z(t) - \frac{1}{L}W_d^T(W_dZ(t) - y))$$

The inner expression $Z(t) - \frac{1}{L}W_d^T(W_dZ(t) - Y)$ is a gradient step for the $||y - Wz||^2$ term. The $\text{Shrinkage}$ function then shifts values towards 0, which optimizes the $\lambda ||z||_{L_1}$ term.
...
<center>
<img src="https://i.imgur.com/n6FwiqT.png" height="50%" width="50%"/><br>
...
$$S = I - \frac{1}{L}W_d^TW_d$$

and then write

$$z(t+1) = \text{Shrinkage}_{\frac{\lambda}{L}}[W_e^Ty - Sz(t)]$$
...
<center>
<img src="https://i.imgur.com/K05fRly.png" height="70%" width="80%"/><br>
...
<center>
<img src="https://i.imgur.com/uReLQo3.png" height="70%" width="90%"/><br>
...
<center>
<img src="https://i.imgur.com/QCPbLNV.png" height="90%" width="90%"/><br>
...
<center>
<img src="https://i.imgur.com/sza5WS8.png" height="90%" width="90%"/><br>
<b>Fig. 7 </b> Convolutional sparse encoding on color image
</center>
...
<center>
<img src="https://i.imgur.com/yAx3m3i.png" height="50%" width="50%"/><br>
...
| <center><img src="https://i.imgur.com/FDSLD7H.png" height="75%" width="75%"/><br>(a) Original set of fuzzy balls </center> | <center><img src="https://i.imgur.com/4vDWN9E.png" height="75%" width="75%"/><br>(b) Movement of fuzzy balls due to energy minimization without regularization</center>  | 
...
<center>
<img src="https://i.imgur.com/Lv3qPXb.png" height="50%" width="50%"/><br>
