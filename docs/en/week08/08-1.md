...
To distinguish the characteristics of different training methods, Dr. Yann LeCun has further summarized 7 strategies of training from the two classes mention before. One of which is methods that are similar to Maximum Likelihood method, which push down the energy of data points and push up everywhere else.
>>>>>>> 54c72e68bb7fccf0b0a4aa3674ab60bea77e18ad
...
<center>
<img src="{{site.baseurl}}/images/week08/08-1/fig1.png" height="100%" width="50%"/><br>
...
<center>
<img src="{{site.baseurl}}/images/week08/08-1/fig2.png" height="100%" width="50%"/><br>
...
$$h(v_I,v_{I^t})=\frac{\exp(\frac{s(v_I,v_{I^t})}{\tau})}{exp(\frac{s(v_I,v_{I^t})}{\tau})+\sum_{I'\in D_{N}}exp(\frac{s(v_{I^t},v_{I'})}{\tau})}$$
