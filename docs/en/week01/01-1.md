...
$$
\begin{aligned}
\frac{\partial C}{\partial \textbf{x}_{i - 1}} &= \frac{\partial C}{\partial \textbf{x}_i}\frac{\partial \textbf{x}_i}{\partial \textbf{x}_{i - 1}} \\
\frac{\partial C}{\partial \textbf{x}_{i - 1}} &= \frac{\partial C}{\partial \textbf{x}_i}\frac{\partial f_i(\textbf{x}_{i - 1}, \textbf{w}_i)}{\partial \textbf{x}_{i - 1}}
\end{aligned}
$$
...
$$
\begin{aligned}
\frac{\partial C}{\partial \textbf{w}_{i}} &= \frac{\partial C}{\partial \textbf{x}_i}\frac{\partial \textbf{x}_i}{\partial \textbf{w}_{i}} \\
\frac{\partial C}{\partial \textbf{w}_{i}} &= \frac{\partial C}{\partial \textbf{x}_i}\frac{\partial f_i(\textbf{x}_{i - 1}, \textbf{w}_i)}{\partial \textbf{w}_{i}}
\end{aligned}
$$
