...
- أبعاد (الصورة) = **  1024x1024**  = ${6}^{10}$ 

- إذا كان ‪**‬ ‪=‬ 10 N‪**‬  عينة لكل بُعد ، فإن ‪**‬ ${10}^{1,000,000}$ ‪**‬ نقطة  
...
2. كيف يتم حساب إلتفافات طيفية سريعة في زمن قدره‪$‬O‪(‬n‪)$‬ للنَّوَى المدمجة (كما في مطابقة القالب)؟
