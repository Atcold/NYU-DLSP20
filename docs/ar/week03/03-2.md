...
-->
###   أول نموذج "حقيقي" للشبكات الالتفافية  
...
بعد إنتقاله إلى Bell Labs، تحول عمل LeCunn إلى استخدام الرموز البريدية المكتوبة بخط اليد عن طريق خدمة البريد الأمريكية لتدريب شبكة CNN أكبر:
...
على سبيل المثال تجميع (2x2)  مع خطوة انتقالية  2 سيقلل إزاحة 1 بكسل في طبقة الإدخال إلى 0.5 بكسل إزاحة في نماذج الخصائص التالية. يتم بعد ذلك استبدال الدقة المكانية لزيادة عدد أنواع الخصائص،  أي جعل التمثيل أكثر تجريدًا وأقل حساسية للتحولات والتشوهات.
...
يمكن تحليل المعمارية العامة للشبكات الالتفافية لمجموعة من الطبقات الاساسية كما يلي:
