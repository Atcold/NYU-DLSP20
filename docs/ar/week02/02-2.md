...
يعمل ReLU بشكل أفضل مع الشبكات ذات الطبقات المتعددة، وهذا سبب قلة استخدام بدائل كدالة sigmoid ودوال الظل الزائدية $\tanh(\cdot)$. السبب وراء عمل هذه الدالة هو وجود ذاك الالتواء فيها والذي يجعلها متكافئة للمقايس المختلفة. 
