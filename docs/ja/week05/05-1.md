...
いくつかのシナリオが発生する可能性があります。下の画像は、パラメータが１次元の2次関数でのこれらのシナリオを示しています。 学習率が低すぎる場合、確実に最小値に進めますが、訓練時間が予想よりかなりかかる場合があります。
...
<!-- with DeepL -->
SGDでは、最初は解に向かって順調に進んでいきますが、ボウル（谷底）に到達すると、このフロアで跳ねてしまいます。学習率を調整すれば、跳ね返りは緩やかになります。モメンタムでは、跳ね返りがないように、ステップを滑らかにします。