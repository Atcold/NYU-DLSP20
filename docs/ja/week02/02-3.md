...
$$
  X_{k}(t)=t\left(\begin{array}{c}{\sin \left[\frac{2 \pi}{K}(2 t+k-1 )\right]+\mathcal{N}\left(0, \sigma^{2}\right)} \\ {\cos \left[\frac{2 \pi}{K}(2 t+k-1 )\right]+\mathcal{N}\left(0, \sigma^{2}\right)}\end{array}\right)\\0 \leq t \leq 1, \quad k=1, ..., K
$$
