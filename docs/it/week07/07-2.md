...
Una volta *danneggiato* il dato, possiamo incrementarne l'energia qui. Se ripetiamo ciò per un numero sufficiente di volte per tutti i dati, i campioni dell'energia si *raggomitoleranno* attorno agli esempi di addestramento. Il seguente grafico illustra come viene operato l'addestramento:
...
1. Considerare un punto $y$ e modificarlo
2. Addestrare un *encoder* e un *decoder* per ricostruire il dato originale a partire dal punto modificato
