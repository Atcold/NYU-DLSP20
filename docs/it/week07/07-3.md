...
D'altro canto, quando lo stesso dato viene dato in pasto ad un *autoencoder* per *denoising* con una maschera di *dropout* applicata ad ogni immagine prima di applicarvi il modello, si verifica qualcosa di diverso. Ogni filtro che impara un *pattern*, impara anche ad assegnare un valore costante ai pixel esterni alla regione dove si trova il numero.
...
<b>Figure 23:</b> filtri di un AE per *denoising*
...
<b>Figure 25:</b> ricostruzioni dell'*autoencoder* per *denoising*
