...
2. Lo strato convoluzionale passa un filtro (_kernel_) di dimensione *5*$\times$*5* con _stride_ 1 sull'immagine, creando una mappa delle caratteristiche *28*$\times$*28*
...
6. _ReLu_
7. Convoluzione con 20 canali _output_, filtro 5$\times$5, e stride di 1.
8. _Max Pooling_ di dimensione 2$\times$2, stride di 2.
9. _ReLu_
10. Convoluzione con 20 canali _output_, filtro 5$\times$5, stride di 1.
