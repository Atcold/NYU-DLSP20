...
lang: it
lang-ref: ch.03-2
title: CNN: evoluzione, architetture, implementazione dettagliata e vantaggi
...
## [Evoluzione da CNN-prototipo alle CNN moderne](https://www.youtube.com/watch?v=FW5gFiJb-ig&t=2949s)
...
+ 12 filtri (5$\times $5) con _stride_ 2 (avanzamento di 2 pixel): il prossimo strato avrà una risoluzione inferiore
...
2. Lo strato convoluzionale passa un _kernel_ di dimensione *5*$\times$*5* con _stride_ 1 sull'immagine, creando una mappa delle caratteristiche *28*$\times$*28*
...
Anche se `fc1` e `fc2` sono strati completamente connessi (_FC_), si possono consdierare come strati convoluzionali con filtri che ricoprono l'intero _input_. Gli strati _FC_ vengono utilzizati per motivi di efficenza.
