...
lang-ref: ch.08-2
lang: it
title: Modelli basati sull'energia a variabile latente regolarizzata
...
## EBM a variabile latente regolarizzata
...
### *Autoencoder variazionale* (*Variational Autoencoder*)

<!-- ### Variational Autoencoder -->

Gli *autoencoder variazionali* hanno un'architettura simile agli EBM con variabile latente regolarizzata, con l'eccezione della sparsità. Qui, invece, il contenuto informativo del codice è limitato dalla rumorosità.
...
I vettori della codifica con aggiunta di rumore gaussiano possono essere visualizzati come sfere sfocate, come mostrato in Fig. 8(a).
...
Però, si vuole che le sfere sfocate si concentrino attorno una varietà dei dati, se ce n'è una. Di conseguenza, i vettori delle codifiche vengono regolarizzati in modo tale da avere una media e una varianza vicine a zero. Per fare ciò, le "colleghiamo" all'origine con una molla, come mostra la Fig. 9.
...
Non è possibile adattare la dimensione delle sfere sfocate. Essa è limitata da una funzione di penalità (divergenza di Kullback-Leibler) che cerca di rendere la varianza vicina ad 1 così che la dimensione della sfera non è né troppo grande né troppo piccola da collassare.
