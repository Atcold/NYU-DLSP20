...
Però, si vuole che le sfere sfocate si concentrino attorno una varietà dei dati, se ce n'è una. Di conseguenza, i vettori delle codifiche vengono regolarizzati in modo tale da avere una media e una varianza vicine a zero. Per fare ciò, le "colleghiamo" all'origine con una molla, come mostra la Fig. 10.
