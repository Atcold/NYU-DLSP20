...
### [Perdita di entropia incrociata (_Binary Cross Entropy, BCE_) - `nn.BCELoss()`](https://www.youtube.com/watch?v=bj1fh3BvqSU&t=3207s)
...
### Perdita a triade di margini - `nn.TripletMarginLoss()`
