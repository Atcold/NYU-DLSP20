...
-->
RNN è un tipo di architettura che possiamo utilizzare per gestire sequenze di dati. Cos'è una sequenza? Dalla lezione sulle CNN, abbiamo appreso che un segnale può essere 1D, 2D o 3D a seconda del dominio. Il dominio è definito da cosa stai mappando e da cosa stai mappando. La gestione dei dati sequenziali ha a che fare essenzialmente con i dati 1D poiché il dominio è solo input temporale di X. Tuttavia, puoi anche utilizzare RNN per gestire i dati 2D, dove hai due direzioni.
...
-->
### Quattro tipi di architetture di RNNs ed Esempi
...
<center>
<img src="{{site.baseurl}}/images/week06/06-3/second_2.png" style="zoom: 40%; background-color:#DCDCDC;"/><br>
<b>Figura 9:</b> Linee di codice Python in ingresso in un caso più completo
</center>
