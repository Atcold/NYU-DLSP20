...
Data la lunghezza $L$ della cabina di guida, $d_1$ è la distanza fra cabina e rimorchio e $d_2$ la distanza del rimiorchio. Possiamo ora calcolare la variazione di angolo e posizione:
