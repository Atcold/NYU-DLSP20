...
Il Notebook Jupyter si trova qui [here](https://github.com/Atcold/pytorch-Deep-Learning/blob/master/02-space_stretching.ipynb). Per eseguire il notebook, assicurarsi di disporre dell'ambiente  `pDL` installato come specificato in  [`README.md`](https://github.com/Atcold/pytorch-Deep-Learning/blob/master/README.md).
