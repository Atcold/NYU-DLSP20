...
Similarly, in the RNN diagram, you can have the same additional items between neurons.
...
Eğer BTT periodu $T$'ye 3 atanmışsa, RNN'deki ilk girdi $x[1:T]$ ve çıktı $y[1:T]$ şöyle belirlenir
