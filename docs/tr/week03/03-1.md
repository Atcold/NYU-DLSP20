...
Fukushima, basit ve karmaşık hücrelerin birden fazla katmanla bilgisayar modellerinde kullanılması fikrinin ilk sahibiydi, ve bunun için elle yazılmış rakam verilerini kullandı. Bu öznitelik algılayıcılarının bazıları özel olarak oluşturulmuş ve öğrenilmişti; ama öğrenme denetimsiz öbekleme algoritmalarını kullanıyordu, her katman için ayrı ayrı eğitiliyordu ve geri yayılım henüz kullanımda değildi.
