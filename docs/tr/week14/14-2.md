...
Yukarıdaki figürde yanlış yollar -1 değerindedir.
...
<center>
Tablo 1: Various Loss Equations
</center>
...
* Menteşe loss is taking the energy of the most offending answer, and the correct answer, and computing their difference. Intuitively, with a margin m, the hinge will only have loss of 0 when the correct energy is lower than the most offending energy by _at least_ m.
...
Jensen'in Eşitsizliği geometrik bir gözlem olup şu söylemi ifade eder: Eğer konveks bir fonksiyonumuz varsa, o fonksiyonun  bir bölgedeki ortalamada daldığı değer  fonksiyonun aynı bölgedeki averajından küçük olacaktır. Geometrik olarak düşünürsek:
...
<b>Figure 6:</b> Jensen'in Eşitsizliği ([Wikipedia](https://en.wikipedia.org/wiki/Jensen%27s_inequality)'dan alınmıştır)
</center>
