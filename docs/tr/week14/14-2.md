...
<center>
Tablo 1: Çeşitli Kayıp Denklemleri
</center>
...
Soru: What are some examples of problems that can use decoders? 
Cevap: Dil modelleri, makine translasyonu, ve dizi etiketleme.
<!--
### DEFINITION:
A decoder inputs a sequence of vectors that indicate the scores or energy of individual sounds or images, and picks out the best possible output.
