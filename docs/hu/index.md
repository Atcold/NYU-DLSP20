...
| OKTATÓK | Yann LeCun & Alfredo Canziani |
...
## Leírás
Ez a kurzus a *Deep Learning* valamint *Representation Learning* legújabb technikáit tárgyalja, különös tekintettel a felügyelt (*supervised*) és nem felügyelt (*unsupervised*) mély tanulásra (*deep learning*), *embedding* módszerekre, *metric* tanulásra, *convolutional* és *recurrent* hálózatokra; a gépi látás (*computer vision*), a természetes nyelv valamint beszédfelismerés alkalmazási területein. A kurzus előfeltételei: [DS-GA 1001 Intro to Data Science](https://cds.nyu.edu/academics/ms-curriculum/) vagy mesterfokú képzésen gépi tanulás (*machine learning*) kurzus elvégzése.


## Előadások

**Legend**: 🖥 Prezentáció, 📓 Jupyter notebook, 🎥 YouTube videó.
...
<!-- =============================== HEADER ================================ -->
  <thead>
    <tr>
      <th>Hét</th>
      <th align="left">Formátum</th>
      <th align="left">Cím</th>
      <th align="left">Anyagok</th>
    </tr>
  </thead>
  <tbody>
<!-- =============================== WEEK 1 ================================ -->
...
| Szerepkör | Fotó | Kapcsolat | Leírás |
|:-----|:-----:|:--------|:------|
