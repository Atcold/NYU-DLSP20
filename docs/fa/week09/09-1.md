...
یک نظم‌دهنده است. به خودی خود آموزش داده نمی شود، ثابت است. این فقط نرم L2 گروه ها است و گروه ها از قبل تعیین شده اند. اما از آنجا که یک معیار است، تعیین می کند که انکودر و دیکودر چه کاری را انجام می‌دهند و چه نوع ویژگی هایی استخراج می شوند.
