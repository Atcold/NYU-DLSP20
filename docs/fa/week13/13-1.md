...
-->
## [شبکه های عصبی کانولوشنی سنتی(CovNets)](https://www.youtube.com/watch?v=Iiv9R6BjxHM&list=PLLHTzKZzVU9eaEyErdV26ikyolxOsz6mq&index=24&t=50s لینک ویدیو:)
...
-->
یک عکس با ابعاد 1024 در 1024 پیکسلی را در نظر بگیرید. این عکس را می توان نقطه ای در فضا در نظر گرفت که با یک میلیون بعد توصیف می شود. استفاده از 10 نمونه از این عکس ها بر حسب بعد اندازه برابر با ${10}^{1,000,000}$ دارند که شدیدا عددی بزرگ می باشد. CovNets شبکه های عصبی بسیار قدرتمندی هستند که قادر به استخراج بهترین ارایه از داده های تصویری با ابعاد بالا همانند مثال ارایه شده هستند. 
...
* **الگو محلی**  یک نرون در شبکه عصبی بجای اتصال به تمامی لایه ها در شبکه تنها به لایه های همسایه متصل است
...
* **ساکن** ها دارای شباهت هستند و در دامنه تصویر تکرار شده اند. به عنوان مثال این موضوع حضور ملافه زرد در میانه شکل 2
...
* ** سلسله مراتبی**  ترکیب ویژگیهای مرتبه پایین ویژگی های مرتبه متو سط را تشکیل می  دهند. سپس ترکیب این ویژگیهای مرتبه متوسط به صورت ادامه دار ویژگیهای مرتبه های بالاتر را.مثال ارایه تصویرگرا Subsequently, these medium level features will combined to progressively form higher and higher level features. For example, a visual representation.
