...
LeCun (1990) đã sử dụng backprop để huấn luyện CNN nhận dạng các chữ viết tay. Có một bản thử nghiệm từ năm 1992, trong đó thuật toán nhận dạng các chữ số viết tay của bất kỳ kiểu nào. Thực hiện nhận dạng ký tự/ 
