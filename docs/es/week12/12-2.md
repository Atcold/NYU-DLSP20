...
Una técnica de muestreo pura en la que se trunca la distribución a los $ k $ mejores y luego se vuelve a normalizar y se muestra la distribución.
...
Finalmente, entrene el modelo de alemán a inglés usando las palabras alemanas que han sido 'retro-traducidas' en el paso anterior. Notamos eso:
...
#### ¿Podemos evaluar si el modelo ya tiene conocimiento global?
