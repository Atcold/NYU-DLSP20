...
$$
X_{k}(t)=t\left(\begin{array}{c}{\sin \left[\frac{2 \pi}{K}(2 t+k-1)\right]} \\\\N{cos \N{gauche[\frac{2 \pi}{K}(2 t+k-1)\right]}\end{array}\right) \\N
0 \leq t \leq 1, \quad k=1, ..., K
$$
...
$$
\mathcal{L}(\boldsymbol{\hat{\}}, \boldsymbol{\c}) = \frac{\1}{m} \sum_{i=1}^m \ell(\boldsymbol{\hat{\y}_i}, c_i), \quad
\ell(\boldsymbol{\hat{y}}, c) = -\log(\boldsymbol{\hat{y}}[c])
$$
