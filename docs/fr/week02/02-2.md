...
<center><img src="{{site.baseurl}}}/images/week02/02-2/02-2-1.png" alt="Diagramme de gradient" style="zoom:40% ;" /></center>
...
$$
\frac{\partiel C(y,\bar{y})}{\partiel w}=1 \cdot \frac{\partiel C(y,\bar{y})}{\bar{y}}\cdot\frac{\partiel G(x,w)}{\partiel w}
$$

En termes de dimensions, $\frac{\partiel C(y,\bar{y})}{\partiel w}$ est un vecteur ligne de taille $1\times N$ où $N$ est le nombre de composantes de $w$ ; $\frac{\partiel C(y,\bar{y})}{\partiel \bar{y}}$ est un vecteur ligne de taille $1\fois M$, où $M$ est la dimension de la sortie ; $\frac{\partiel \bar{y}}{\partiel w}=\frac{\partiel G(x,w)}{\partiel w}$ est une matrice de taille $M\times N$, où $M$ est le nombre de sorties de $G$ et $N$ est la dimension de $w$.
...
<center><img src="{{site.baseurl}}}/images/week02/02-2/02-2-2.png" alt="Fonction sigmoïde pour illustrer la disparition du gradient" style="background-color:#DCDCDCDC ;" /></center>
...
$$
L(S, w) = C(S, w) + \alpha \Vert w \Vert^2\\
\frac{\partiel R}{\partiel w_i} = 2w_i\\\\
w_i = w_i - \eta\frac{\partiel L}{\partiel w_i} = w_i - \eta \left( \frac{\partiel C}{\partiel w_i} + 2 \alpha w_i \right)
$$
...
$$
w_i = (1 - 2 \eta \alpha) w_i - \eta\frac{\partie C}{\partie w_i}
$$
