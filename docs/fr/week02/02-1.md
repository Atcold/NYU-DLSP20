...
| <center><img src="{{site.baseurl}}}/images/week02/02-1/Figure1.jpg" alt="Figure1" style="zoom : 33% ;" /></center> |
| <center>Figure 1 : Représentation graphe pour un modèle paramétré </center>|
...
- Utilisation de la règle en chaîne pour les fonctions vectorielles
  ...
  $$
  \frac{\partiel c}{\partiel {z_k}}=\frac{\partiel c}{\partiel {z_{k+1}}}\frac{\partiel {z_{k+1}}}{\partiel {z_k}}=\frac{\partiel c}{\partiel {z_{k+1}}}\frac{\partiel f_k(z_k,w_k)}{\partiel {z_k}}}
  $$

  $$
  \frac{\partiel c}{\partiel {w_k}}=\frac{\partiel c}{\partiel {z_{k+1}}}\frac{\partiel {z_{k+1}}}{\partiel {w_k}}=\frac{\partiel c}{\partiel {z_{k+1}}}\frac{\partiel f_k(z_k,w_k)}{\partiel {w_k}}}
  $$
