...
## Réseau convolutif spectral sur graphe 
...
## Réseau convolutif sur graphe spacial
...
pour plus de($d$) fonctionnalités,
...
$$h_{i}^{l+1} = f_\text{GCN}(h_{i}^{l}, \{h_{j}^l : j \fourchette droite i\})$$
...
<center>
<img src="{{site.baseurl}}/images/week13/13-2/Figure14.png" /><br>
<b>Figure 14:</b> Tâche de classification des bords.
</center>

<center>
<img src="{{site.baseurl}}/images/week13/13-2/Figure15.png" /><br>
<b>Figure 15:</b> Performance de divers GCN sur la tâche de classification des bords
</center>
