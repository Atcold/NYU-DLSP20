...
## Introduction au réseau convolutif sur graphe
...
Nous avons également plusieurs sommets $v_{j}$, qui se composent de $\boldsymbol{x}_{j}$ et de $\boldsymbol{h}_{j}$.
...
## Théorie et code du réseau à rupteur convolutif à résidu sur graphe 
...
### Mise en œuvre de la couche Gated Residual GCN
