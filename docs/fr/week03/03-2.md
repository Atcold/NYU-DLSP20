...
-->
## [Proto- ConvNets s et evolution vers les ConvNets modernes](https://www.youtube.com/watch?v=FW5gFiJb-ig&t=2949s)
...
### Pproto-CNNs sur de petits jeux de données
...
### Impl”mentation de LeNet5 dans PyTorch
